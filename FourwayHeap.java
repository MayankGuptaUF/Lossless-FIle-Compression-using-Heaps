...
public class FourwayHeap {
	...
	{
		heaparray = new Huffman_Node[freq_table.size()]; // create an array heaparray of size same as the no of keys
		int pos = 0;
	...
	private void deleteMin()
	{
		...
		heapsize=heapsize-1;// Heap size is decreased by 1 as we lose an elemen
